...
files_to_download = [
    {"url": "https://zenodo.org/records/8196385/files/HDFS_v1.zip?download=1", "name": "HDFS_v1.zip"},
    {"url": "https://zenodo.org/records/8196385/files/BGL.zip?download=1", "name": "BGL.zip"}
]
...
for file_info in files_to_download:
    ...
    if response.status_code == 200:
        ...
        print(f"File unzipped to 'input' folder")
