...
import pandas as pd
import numpy as np
para = {"window_size":0.5,"step_size":0.2,"structured_file":"result/BGL.log_structured.csv","BGL_sequence":'result/BGL_sequence.csv'}
...
def load_BGL():
    ...
    bgl_structured["SecondsSince"] = (bgl_structured['Time']-bgl_structured['Time'][0]).dt.total_seconds().astype(int)
