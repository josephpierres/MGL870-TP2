...
log_file = 'openstack_normal2.log'  # Nom du fichier de log d'entrée

# Format de log pour correspondre à la structure du log Openstack
log_format = '<LogFile> <Date> <Time> <PID> <Level> <Component> [<Request_ID> <User_ID> <Project_ID> - - -] [instance: <Instance_ID>] <Message>'
